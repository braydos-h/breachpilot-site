  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 border-b bg-muted/40 px-4 py-2.5">
        ...
        <span className="ml-auto inline-flex items-center gap-1.5 rounded-full border bg-background px-2 py-0.5 text-xs font-medium">
          <StatusDot tone="ok" />
          RUNNING
        </span>
      </div>
      ...
      <div className="grid sm:grid-cols-[1fr_1.1fr]">
        ...
        <div className="border-b p-4 sm:border-b-0 sm:border-r">
          ...
          <p className="mt-2 inline-flex items-center gap-1.5 rounded-md border bg-muted/50 px-2 py-1 font-mono text-xs">
          ...
          <ol className="mt-4 space-y-2">
            {[
              ...
              <li key={s.label} className="flex items-center gap-2.5 text-sm">
                ...
                <span className="ml-auto hidden font-mono text-xs text-muted-foreground min-[400px]:block">{s.note}</span>
              </li>
            ))}
          </ol>
        </div>
        ...
        <div className="bg-grid-sm p-4">
          ...
          <p className="mt-3 flex items-center gap-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
